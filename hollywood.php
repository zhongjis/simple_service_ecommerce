...
<html>
	<head>
		<title>Hollywood Settlement Service</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Hollywood Settlement Service</h1>
		<img src="images/hollywood.jpeg" alt="hollywood">
		<p>Want to buy the whole Hollywood? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('hollywood')" id='findMoreBtn'>Find Out More</button>
