...
<html>
	<head>
		<title>Valley Settlement Service</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Valley Settlement Service</h1>
		<img src="images/somewherenice.jpg" alt="valley">
		<p>Want to own your own valley? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('valley')" id='findMoreBtn'>Find Out More</button>
