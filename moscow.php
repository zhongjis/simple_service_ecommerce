...
<html>
	<head>
		<title>Moscow Settlement Service</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Moscow Settlement Service</h1>
		<img src="images/moscow.jpeg" alt="moscow">
		<p>Want to live in Moscow? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('moscow')" id='findMoreBtn'>Find Out More</button>
