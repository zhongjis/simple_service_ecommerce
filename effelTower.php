...
<html>
	<head>
		<title>Effel Tower Settlement Service</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Effel Tower Settlement Service</h1>
		<img src="images/effelTower.jpeg" alt="effelTower">
		<p>Want to have your own living space on Effel Tower? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('effel tower')" id='findMoreBtn'>Find Out More</button>
