...
<html>
	...
	<body>
		...
		<p>Want a camel at home and ride it anywhere you want? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('camel')" id='findMoreBtn'>Find Out More</button>
		...
		<script src="scripts/product.js"></script>	</body>
</html>