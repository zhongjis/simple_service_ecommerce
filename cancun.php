...
<html>
	<head>
		<title>Cancun Settlement Service</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Cancun Settlement Service</h1>
		<img src="images/cancun.jpeg" alt="camel">
		<p>Want to buy an island near Cancun? Want to have your own beach? We can help you! Just fill out the form below and we can help you achieve your dream!</p>
		<button onclick="findOutMore('cancun island')" id='findMoreBtn'>Find Out More</button>
